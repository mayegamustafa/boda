...
class MyDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Drawer(
      ...
      shape: Border.all(color: context.isDark ? Colors.black : Colors.white),
      child: Column(
        children: [
          Gap(48.h),
          // Header section
        ...
        ListTile(
          ...
          trailing: IntrinsicWidth(
            child: Container(
              ...
              child: LocalizationSelector(dropdownKey: dropdownKey),
            ),
          ),
          // onTap: () {
        ...
        ListTile(
          ...
          trailing: ValueListenableBuilder(
            ...
            builder: (context, box, _) {
              return Switch(
                value: box.get(AppConstants.isDarkTheme) ?? false,
                onChanged: (value) {
                  Hive.box(
                    AppConstants.appSettingsBox,
                  ).put(AppConstants.isDarkTheme, value);
                },
              );
            },
          ),
          ...
          children: [
            Row(
              children: [
                ...
                Gap(2.w),
                SvgPicture.asset(icon, width: 24.r, height: 24.r),
              ],
            ),
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
              ...
              top: BorderSide(width: 0.5, color: Color(0xFFF1F1F5)),
              right: BorderSide(color: Color(0xFFF1F1F5)),
              bottom: BorderSide(width: 0.5, color: Color(0xFFF1F1F5)),
            ),
          ),
          child: Row(
            children: [
              ...
              _summeryCard(
                context: context,
                title:
                    '${S.of(context).cashCollected} ${DateFormat('MMMM').format(DateTime.now())}',
                value: box
                    .get(AppConstants.userData)['current_month_cash_collected']
                    .toStringAsFixed(2),
                isAmount: true,
...
class LocalizationSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: Theme.of(
        context,
      ).copyWith(dialogTheme: DialogThemeData(backgroundColor: Colors.white)),
      child: FormBuilderDropdown<String>(
        ...
        dropdownColor: context.isDark ? Colors.grey : Colors.white,
        icon: const SizedBox(),
        initialValue:
